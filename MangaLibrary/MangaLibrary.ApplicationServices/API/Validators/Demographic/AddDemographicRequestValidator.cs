...
{
    public class AddDemographicRequestValidator:AbstractValidator<AddDemographicRequest>
    {
        public AddDemographicRequestValidator(MangaLibraryDbContext context)
        {
